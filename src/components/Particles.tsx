  ...
  return (
    <div className="sparkles-container">
      <div className="sparkles-relative-container">
        ...
        <div className="sparkles-gradient sparkles-gradient-thin" />
        <div className="sparkles-gradient sparkles-gradient-sky-blur" />
        <div className="sparkles-gradient sparkles-gradient-sky-thin" />
